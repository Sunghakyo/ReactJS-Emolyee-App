                ...
                <div className="container-fluid">
                    <div className="row justify-content-center">
                        <div className="col-4 col-md-6">
                            ...
                            <p>Ứng dụng quản lý nhân viên giúp bạn quản lý được cụ thể số lượng nhân viên ở từng phòng ban, có bảng lương tính được lương của nhân viên và nhiều chức năng khác. Bạn hãy trải nghiệm </p>
                        </div>
                        ...
                        <div className="col-4 col-md-3 text-center">
                            ...
                            <ul className="list-unstyled">
                                <li><a href="twitter.com" class="btn btn-social-icon btn-twitter fa fa-twitter" > </a></li>
                                <li><a href="facebook.com" class="btn btn-social-icon btn-facebook fa fa-facebook" > </a></li>
